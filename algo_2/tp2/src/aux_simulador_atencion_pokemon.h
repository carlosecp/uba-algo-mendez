...
/**
 * Comparador de pokemones en base a su nivel. Es utilizado por el heap
 * que almacena los pokemones en la recepcion para que el mantenga a estos
 * pokemones ordenados de tal forma que el pokemon de menor nivel siempre
 * este de primero en el heap (en la raiz).
 */
