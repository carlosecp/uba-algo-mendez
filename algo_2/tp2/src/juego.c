...
int verificar_nivel_nightmare(unsigned nivel_adivinado, unsigned nivel_pokemon) {
...
void juego_inicializar(Juego* juego, hospital_t* hospital) {
	...
	DatosDificultad dificultad_nightmare = {
		.nombre = "Ultra Nightmare",
		.calcular_puntaje = calcular_puntaje_nightmare,
		.verificar_nivel = verificar_nivel_nightmare,
