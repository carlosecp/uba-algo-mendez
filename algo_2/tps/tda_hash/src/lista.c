...
nodo_t*
nodo_en_posicion(nodo_t* nodo_inicial, size_t posicion)
{
	if (!nodo_inicial)
		return NULL;
...
nodo_t*
nodo_anterior_a_posicion_aux(nodo_t* nodo_inicial, size_t posicion)
{
	return nodo_en_posicion(nodo_inicial, posicion - 1);
}

nodo_t*
nodo_penultimo_aux(nodo_t* nodo_inicial)
{
	if (!nodo_inicial)
		return NULL;
