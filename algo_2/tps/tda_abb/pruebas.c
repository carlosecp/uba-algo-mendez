...
dadoUnABB_alAplicarUnaFuncionACadaElemento_seAplicaCorrectamente() {
	...
	pa2m_afirmar(cantidad_recorridos == MAX_RECORRIDOS, "Se les aplica una funcion a todos los elementos del ABB en PREORDEN");

	cantidad_recorridos = abb_con_cada_elemento(arbol, INORDEN, a_cada_estudiante_fiuba, NULL);
	pa2m_afirmar(cantidad_recorridos == MAX_RECORRIDOS, "Se les aplica una funcion a todos los elementos del ABB en INORDEN");

	cantidad_recorridos = abb_con_cada_elemento(arbol, POSTORDEN, a_cada_estudiante_fiuba, NULL);
	pa2m_afirmar(cantidad_recorridos == MAX_RECORRIDOS, "Se les aplica una funcion a todos los elementos del ABB en POSTORDEN");
...
void
dadoUnABB_alQuitarUnElementoDelABB_seRetornaElElemento() {
	abb_t* arbol = abb_crear(comparador_estudiantes_fiuba);
