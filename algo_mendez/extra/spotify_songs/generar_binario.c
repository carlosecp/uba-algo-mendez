...
void cargar_canciones_a_binario(FILE *archivo_canciones_csv,
  ...
  int leidos = fscanf(
      ...
      &cancion_temp.duracion_ms, &cancion_temp.explicita, cancion_temp.artista,
      &cancion_temp.fecha_lanzamiento.dia, &cancion_temp.fecha_lanzamiento.mes,
